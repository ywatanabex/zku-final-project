    ...
    <div className={styles.container}>
        ...
        <main className={styles.main}>
            ...
            <ul className={styles.description}> 
                    <li className={styles.list}> Compute Stable Matching on this browser using GS algorithm </li>
                    <li className={styles.list}> The hash of the matching is registered to the blockchain</li>
            </ul> 
